...
class _HomePageState extends State<HomePage> {
  ...
  void uploadExcelFile(Function(void Function()) setState) async {
    ...
    if (_selectedArbiter == null || _selectedArbiter!.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Clear the selected file and arbiter after a successful upload
        setState(() {
          _selectedFileName = null;
          _selectedFilePath = null;
